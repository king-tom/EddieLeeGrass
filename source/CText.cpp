...
bool CText::Initialize(ID3D11Device* device, ID3D11DeviceContext* deviceContext, HWND hwnd, int screenWidth, int screenHeight, 
...
bool CText::Render(ID3D11DeviceContext* deviceContext, CFontShader* FontShader, D3DXMATRIX worldMatrix, D3DXMATRIX orthoMatrix)
{
	bool result;
...
bool CText::InitializeSentence(SentenceType** sentence, int maxLength, ID3D11Device* device)
{
	VertexType* vertices;
...
bool CText::RenderSentence(SentenceType* sentence, ID3D11DeviceContext* deviceContext, CFontShader* FontShader, D3DXMATRIX worldMatrix, 
...
bool CText::SetVideoCardInfo(char* videoCardName, int videoCardMemory, ID3D11DeviceContext* deviceContext)
{
	char dataString[150];
	bool result;
	char tempString[16];
...
bool CText::SetCameraPosition(float posX, float posY, float posZ, ID3D11DeviceContext* deviceContext)
{
...
bool CText::SetCameraRotation(float rotX, float rotY, float rotZ, ID3D11DeviceContext* deviceContext)
{
