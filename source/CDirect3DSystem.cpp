...
CDirect3DSystem::CDirect3DSystem(const CDirect3DSystem& other)
{
}
...
bool CDirect3DSystem::Initialize(int screenWidth, int screenHeight, bool vsync, HWND hwnd, bool fullscreen, float screenDepth, float screenNear)
{
	HRESULT result;
...
void CDirect3DSystem::GetVideoCardInfo(char* cardName, int& memory)
{
...
void CDirect3DSystem::TurnZBufferOn()
{
	m_deviceContext->OMSetDepthStencilState(m_depthStencilState, 1);
	return;
}
...
void CDirect3DSystem::TurnZBufferOff()
{
...
void CDirect3DSystem::TurnOnAlphaBlending()
{
	float blendFactor[4];
...
void CDirect3DSystem::TurnOffAlphaBlending()
{
	float blendFactor[4];
...
void CDirect3DSystem::TurnOnCulling()
{
...
void CDirect3DSystem::TurnOffCulling()
{
...
void CDirect3DSystem::EnableSecondBlendState()
{
	float blendFactor[4];
...
int CDirect3DSystem::GetHeight()
{
	return m_height;
}

int CDirect3DSystem::GetWidth()
{
	return m_width;
}
...
DXGI_FORMAT CDirect3DSystem::GetBackBufferFormat( void )
{
	/*
	DXGI_FORMAT format;
	m_swapChain->GetBuffer(buffer, 0, surface);
	buffer->GetDesc(bufDesc);
	return bufDesc->Format;
	*/
