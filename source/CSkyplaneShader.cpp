////////////////////////////////////////////////////////////////////////////////
// Filename: CSkyplaneShader.cpp
////////////////////////////////////////////////////////////////////////////////
#include "CSkyplaneShader.h"


CSkyplaneShader::CSkyplaneShader()
{
	m_vertexShader = 0;
	m_pixelShader = 0;
	m_layout = 0;
...
CSkyplaneShader::CSkyplaneShader(const CSkyplaneShader& other)
{
}
...
bool CSkyplaneShader::Initialize(ID3D11Device* device, HWND hwnd)
{
	bool result;


	// Initialize the vertex and pixel shaders.
	result = InitializeShader(device, hwnd, "..\\..\\source\\Skyplane.vs", "..\\..\\source\\Skyplane.ps");
	if(!result)
	{
		return false;
	}
...
bool CSkyplaneShader::Render(ID3D11DeviceContext* deviceContext, int indexCount, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, 
...
bool CSkyplaneShader::InitializeShader(ID3D11Device* device, HWND hwnd, char * vsFilename, char * psFilename)
{
	HRESULT result;
...
void CSkyplaneShader::ShutdownShader()
{
...
void CSkyplaneShader::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, char * shaderFilename)
{
	char* compileErrors;
...
bool CSkyplaneShader::SetShaderParameters(ID3D11DeviceContext* deviceContext, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, 
...
void CSkyplaneShader::RenderShader(ID3D11DeviceContext* deviceContext, int indexCount)
{
